    ...
    return """
        ...
        <body>
            ...
            <div class="content">
                ...
                <p>Dưới đây là thông tin về sự kiện sắp tới:</p>
                ...
                <div class="footer">
                    <p>Rất mong sự hiện diện của quý vị tại sự kiện này. Vui lòng xác nhận tham dự nếu có thể.</p>
                    
                    <div class="signature">
                        <p>Trân trọng,<br>
                        <strong>Ban Tổ Chức</strong><br>
                        <small>Hệ thống quản lý sự kiện</small></p>
                    </div>
                </div>
            </div>
        </body>
