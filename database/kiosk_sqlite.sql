...
CREATE TABLE can_bo (
  ma_can_bo TEXT PRIMARY KEY,
  cccd_id TEXT NOT NULL,
...
CREATE TABLE hoc_phan (
  ma_hoc_phan TEXT PRIMARY KEY,
  ten_hoc_phan TEXT NOT NULL,
  so_tin_chi INTEGER NOT NULL
);

CREATE TABLE nhom_tin_chi (
  ma_nhom_tin_chi TEXT PRIMARY KEY,
  ten_nhom_tin_chi TEXT NOT NULL
);

CREATE TABLE lop_tin_chi (
  ma_lop_tin_chi TEXT PRIMARY KEY,
  ma_hoc_phan TEXT NOT NULL,
  hoc_ky TEXT NOT NULL,
  ma_nhom_tin_chi TEXT NOT NULL, 
...
CREATE TABLE lich_hen (
  ...
  trang_thai TEXT NOT NULL CHECK (trang_thai IN ('PENDING', 'FINISHED', 'CANCELED')),
